...
static void test()
{
    ...
    thread_pool pool(std::thread::hardware_concurrency() + 2);
    {
        ...
        ::bench(
            ...
            "Single-Thread Qsort Test\t(size = 16384)", 100);
        ...
        ::bench(
            ...
            "Standard Async Qsort Test\t(size = 16384)", 100);
        ...
        ::bench(
            ...
            "Thread-Pool Qsort Test\t(size = 16384)", 100);
    }

    {
        ...
        ::bench(
            ...
            "Single-Thread Qsort Test\t(size = 65536)", 100);
        ...
        ::bench(
            ...
            "Standard Async Qsort Test\t(size = 65536)", 100);
        ...
        ::bench(
            ...
            "Thread-Pool Qsort Test\t(size = 65536)", 100);
    }

    {
        ...
        ::bench(
            ...
            "Single-Thread Qsort Test\t(size = 262144)", 100);
        ...
        ::bench(
            ...
            "Standard Async Qsort Test\t(size = 262144)", 100);
        ...
        ::bench(
            ...
            "Thread-Pool Qsort Test\t(size = 262144)", 100);
    }
}
