...
[OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) is the state-of-the-art swiftpose estimation algorithm.
...
be deployed in the wild. To resolve this, we develop **OpenPose-Plus**, a high-performance yet flexible swiftpose estimation framework that offers many powerful features:
...
The swiftpose estimation neural network can take days to train.
...
the external tf-swiftpose-estimation project. We are working on providing the Python binding for our high-performance
...
See [tf-swiftpose](https://github.com/ildoonet/tf-swiftpose-estimation/tree/master/tf_pose/pafprocess) for details.
