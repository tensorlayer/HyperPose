...
[OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) is the state-of-the-art poseplus estimation algorithm.
...
be deployed in the wild. To resolve this, we develop **OpenPose-Plus**, a high-performance yet flexible poseplus estimation framework that offers many powerful features:
...
The poseplus estimation neural network can take days to train.
...
the external tf-poseplus-estimation project. We are working on providing the Python binding for our high-performance
...
See [tf-poseplus](https://github.com/ildoonet/tf-poseplus-estimation/tree/master/tf_pose/pafprocess) for details.
