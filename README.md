...
[OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) is the state-of-the-art sp estimation algorithm.
...
be deployed in the wild. To resolve this, we develop **OpenPose-Plus**, a high-performance yet flexible sp estimation framework that offers many powerful features:
...
The sp estimation neural network can take days to train.
...
the external tf-sp-estimation project. We are working on providing the Python binding for our high-performance
...
See [tf-sp](https://github.com/ildoonet/tf-sp-estimation/tree/master/tf_pose/pafprocess) for details.
