...
def tf_keypoint_random_crop(image, annos, mask=None, size=(368, 368)):
    ...
    def pose_crop(image, annos, mask, x, y, w, h):  # TODO : speed up with affine transform
        ...
        print("=================== joint tensors check===================")
        joint_tensor = tf.convert_to_tensor([0,0],dtype=tf.int32)
